...
x0_star3 = x0*1.1; y0_star3 = 0; z0_star3=0;

vx0 = 0; vy0 = -70; vz0 = 0.;
vx0_moon = 0; vy0_moon = 0;vz0_moon = 0.;
vx0_star3 = 0; vy0_star3 = 0.6*vy0;vz0_star3 = 0.;
...
r0_star3 = [x0_star3, y0_star3, z0_star3];
v0_star3 = [vx0_star3, vy0_star3, vz0_star3];

velo = v0; r = r0; %this is earth in notation but is middle heaviest star in this simulation
dist_sun2e = sqrt (r * r'); 
...
velo_moon = v0_moon; r_moon = r0_moon; %moon is the heaviest star in this simulation
...
velo_star3 = v0_star3; r_star3 = r0_star3;
r_moon2star3 = r_star3 - r_moon; 
dist_moon2star3 = sqrt(r_moon2star3 * r_moon2star3');
force1 = -G*m_star3*m_moon/dist_moon2star3^3 * r_moon2star3;
r_e2star3 = r_star3 - r;
dist_e2star3 = sqrt(r_e2star3 * r_e2star3');
force2 = -G*m_star3*m/dist_e2star3^3 * r_e2star3;
accel_star3 = (force1+force2)/m_star3;
...
for i=1:N
    ...
    velo_star3 = velo_star3 + 0.5*dt*accel_star3;
    r = r + dt * velo;
    r_moon = r_moon + dt*velo_moon;
    r_star3 = r_star3+ dt*velo_star3;
    ...
    plot(xxx,yyy,'ro','MarkerEdgeColor','r',...
                'MarkerFaceColor','g','LineWidth',2,'MarkerSize',2); 

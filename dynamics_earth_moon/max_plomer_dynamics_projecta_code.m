...
x0 =  147e9 ; y0 = 0; z0=0; %Capture 
x0_moon = x0+38440000 ; y0_moon = 0; z0_moon=0;

vx0 = 0; vy0 = 2*pi*x0/(365*24*3600); vz0 = 0.;
vx0_moon = 0; vy0_moon = vy0+1030; vz0_moon = 0.;


G=6.67300e-11; %m^3 kg^-1 s^-2

m=5.9742e24;  M=1.98892e30 ; %M is now mass of sun
m_moon = 7.36e22;
...
force1 = -G*M*m_moon/dist_moon^3 * r0_moon;
r_e2moon = r0_moon-r;
...
for i=1:N
    ...
    %%%%%%%%
    dist_moon = sqrt (r_moon * r_moon'); 
    force1 = -G*M*m_moon/dist_moon^3 * r_moon;
    ...
    plot(0,0,'bo','MarkerEdgeColor','b',...
                'MarkerFaceColor','b','LineWidth',2,'MarkerSize',10);
